...
function lm_get_optimize!(o::LMOptimizer, fn::Function, μ0::VecI; βy::Real=1.0, τ::Real=1e-3, h::Real=0.1, itmax::Int=100)
    #### Allocations ####
